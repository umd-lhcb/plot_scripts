...
int main(){
  ...
  string newIso = "((iso_type1>1&&iso_bdt1<0.15) || (iso_type2>2&&iso_bdt2<0.15) || (iso_type3>1&&iso_bdt3<0.15))";
  ...
  pm.Push<Hist1D>(Axis(30,0,30, "mu_p", "p_{#mu} [GeV]"), "1", procs, linplot);
  pm.Push<Hist1D>(Axis(30,0,3, "mu_pt", "p_{T,#mu} [GeV]"), "1", procs, linplot);
  pm.Push<Hist1D>(Axis(50,0,2, "spi_pt", "#pi_{soft} p_{T} [GeV]"), "1", procs, linplot);
  pm.Push<Hist1D>(Axis(50,-0.4,12.6, "q2", "q^{2} [GeV^{2}]"), "1", procs, linplot);
  pm.Push<Hist1D>(Axis(43, -2, 10.9, "mm2", "m^{2}_{miss} [GeV^{2}]"), "1", procs, linplot);
  pm.Push<Hist1D>(Axis(34, 100,2650, "1000*el", "E^{*}_{#mu} [MeV]"), "1", procs, linplot);
