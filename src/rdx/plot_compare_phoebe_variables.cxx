...
int main(){
  ...
  procsDV.push_back(Process::MakeShared<Baby_run1>("DaVinci42 2012 MD",Process::Type::data, colors("data"),
                                                       set<string>({repofolderDV+"Dst--19_07_12--std--data--2012--md--dv42-subset.root"}), "1"));
  procsDV.push_back(Process::MakeShared<Baby_run1_old>("DaVinci36 2012 MD",Process::Type::signal, colors("blue"),
                                                       set<string>({repofolderDV+"Dst--19_07_12--std--data--2012--md--dv36-subset.root"}), "1"));
