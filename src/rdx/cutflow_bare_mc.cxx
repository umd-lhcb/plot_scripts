...
int main(int argc, char *argv[]){
  ...
  table_rows.push_back(TableRow("$q^2 < 6\\text{ GeV}^2$",fullcut && "FitVar_q2/1000000 < 6", 1,0, "1"));
  ...
  // pm.Push<Hist1D>(Axis(100,0,25, "d0_PT/1000", "p_{T}(D^{0}) [GeV]"), "FitVar_q2/1000000<6" && fullcut, procs, linplot).RatioTitle("2016", "2012").SetTitle("q^{2} < 6 GeV^{2}").Tag("mc");
  // pm.Push<Hist1D>(Axis(100,0,10, "mu_PT/1000", "p_{T}(#mu^{+}) [GeV]"), "FitVar_q2/1000000<6" && fullcut, procs, linplot).RatioTitle("2016", "2012").SetTitle("q^{2} < 6 GeV^{2}").Tag("mc");

  // pm.Push<Hist1D>(Axis(96,140,152, "dst_M - d0_M","unset"), "FitVar_q2/1000000<6" && fullcut, procs, linplot).RatioTitle("2016", "2012").SetTitle("q^{2} < 6 GeV^{2}").Tag("mc");
  // pm.Push<Hist1D>(Axis(96,140,152, "dst_MM - d0_MM"), "FitVar_q2/1000000<6" && fullcut, procs, linplot).RatioTitle("2016", "2012").SetTitle("q^{2} < 6 GeV^{2}").Tag("mc");
  // pm.Push<Hist1D>(Axis(80,1820,1900, "d0_M","unset"), "FitVar_q2/1000000<6" && fullcut, procs, linplot).RatioTitle("2016", "2012").SetTitle("q^{2} < 6 GeV^{2}").Tag("mc");
  // pm.Push<Hist1D>(Axis(80,1820,1900, "d0_MM","unset"), "FitVar_q2/1000000<6" && fullcut, procs, linplot).RatioTitle("2016", "2012").SetTitle("q^{2} < 6 GeV^{2}").Tag("mc");
  // pm.Push<Hist1D>(Axis(100,0,200, "dst_FD_ORIVX"), "FitVar_q2/1000000<6" && fullcut, procs, linplot).RatioTitle("2016", "2012").SetTitle("q^{2} < 6 GeV^{2}").Tag("mc");
  // pm.Push<Hist1D>(Axis(70,0,0.1, "mu_TRACK_GhostProb"), "FitVar_q2/1000000<6" && fullcut, procs, linplot).RatioTitle("2016", "2012").SetTitle("q^{2} < 6 GeV^{2}").Tag("mc");
  // pm.Push<Hist1D>(Axis(70,0,14, "mu_PIDmu"), "FitVar_q2/1000000<6" && fullcut, procs, linplot).RatioTitle("2016", "2012").SetTitle("q^{2} < 6 GeV^{2}").Tag("mc");
  ...
  // pm.Push<Hist1D>(Axis(40,-1,0.15, "b0_ISOLATION_BDT"), "FitVar_q2/1000000<6" && fullcut, procs, linplot).RatioTitle("2016", "2012").SetTitle("q^{2} < 6 GeV^{2}").Tag("mc");
 
  // pm.Push<Hist1D>(Axis(80, -2, 10, "FitVar_Mmiss2/1000000", "m_{miss}^{2} [GeV^{2}]"), "FitVar_q2/1000000<6" && fullcut, procs, linplot).RatioTitle("2016", "2012").SetTitle("q^{2} < 6 GeV^{2}").Tag("mc");
  // pm.Push<Hist1D>(Axis(80, -2, 10, "FitVar_Mmiss2/1000000", "m_{miss}^{2} [GeV^{2}]"), "FitVar_q2/1000000>6" && fullcut , procs, linplot).RatioTitle("2016", "2012").SetTitle("q^{2} > 6 GeV^{2}").Tag("mc");
